...
matlabbatch{3}.spm.spatial.preproc.channel.write = [0 1]; % save bias corrected image
matlabbatch{3}.spm.spatial.preproc.tissue(1).tpm = {[spm('dir'),'/tpm/TPM.nii,1']};
matlabbatch{3}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(1).native = [1 1];
matlabbatch{3}.spm.spatial.preproc.tissue(1).warped = [1 1];
matlabbatch{3}.spm.spatial.preproc.tissue(2).tpm = {[spm('dir'),'/tpm/TPM.nii,2']};
matlabbatch{3}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(2).native = [1 1];
matlabbatch{3}.spm.spatial.preproc.tissue(2).warped = [1 1];
matlabbatch{3}.spm.spatial.preproc.tissue(3).tpm = {[spm('dir'),'/tpm/TPM.nii,3']};
...
matlabbatch{4}.spm.util.tvol.mask = {'/Users/ellenzakreski/spm12/tpm/mask_ICV.nii,1'};
